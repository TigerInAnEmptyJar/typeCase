...
void ATrackTreeOutput::initialize(const string& filename)
{
  ...
  if (nP > 0) {
    pklTree->Branch("prompt.theta", &outPrompt.theta,
                    (string("prompt.theta[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.phi", &outPrompt.phi,
                    (string("prompt.phi[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.beta", &outPrompt.beta,
                    (string("prompt.beta[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.theta_kf", &outPrompt.theta_kf,
                    (string("prompt.theta_kf[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.phi_kf", &outPrompt.phi_kf,
                    (string("prompt.phi_kf[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.beta_kf", &outPrompt.beta_kf,
                    (string("prompt.beta_kf[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.vertex_x", &outPrompt.vertex_x,
                    (string("prompt.vertex_x[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.vertex_y", &outPrompt.vertex_y,
                    (string("prompt.vertex_y[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.vertex_z", &outPrompt.vertex_z,
                    (string("prompt.vertex_z[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.chi", &outPrompt.chi,
                    (string("prompt.chi[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.nEl", &outPrompt.nel,
                    (string("prompt.nEl[") + string_number(nP) + "]/S").data());
    pklTree->Branch("prompt.ID", &outPrompt.id,
                    (string("prompt.ID[") + string_number(nP) + "]/S").data());
    ...
    pklTree->Branch("prompt.path", &trackpaths,
                    (string("prompt.path[") + string_number(nP) + "]/F").data());
    pklTree->Branch("prompt.path1", &trackpaths1,
                    (string("prompt.path1[") + string_number(nP) + "]/F").data());
  }
  if (nv > 0) {
    pklTree->Branch("vee.theta1", &outVee.theta1,
                    (string("vee.theta1[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.phi1", &outVee.phi1,
                    (string("vee.phi1[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.beta1", &outVee.beta1,
                    (string("vee.beta1[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.theta2", &outVee.theta2,
                    (string("vee.theta2[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.phi2", &outVee.phi2,
                    (string("vee.phi2[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.beta2", &outVee.beta2,
                    (string("vee.beta2[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.theta1_kf", &outVee.theta1_kf,
                    (string("vee.theta1_kf[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.phi1_kf", &outVee.phi1_kf,
                    (string("vee.phi1_kf[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.beta1_kf", &outVee.beta1_kf,
                    (string("vee.beta1_kf[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.theta2_kf", &outVee.theta2_kf,
                    (string("vee.theta2_kf[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.phi2_kf", &outVee.phi2_kf,
                    (string("vee.phi2_kf[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.beta2_kf", &outVee.beta2_kf,
                    (string("vee.beta2_kf[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.vertex_x", &outVee.vertex_x,
                    (string("vee.vertex_x[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.vertex_y", &outVee.vertex_y,
                    (string("vee.vertex_y[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.vertex_z", &outVee.vertex_z,
                    (string("vee.vertex_z[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.chi", &outVee.chi,
                    (string("vee.chi[") + string_number(nv) + "]/F").data());
    pklTree->Branch("vee.nEl1", &outVee.nel1,
                    (string("vee.nEl1[") + string_number(nv) + "]/S").data());
    pklTree->Branch("vee.ID1", &outVee.id1,
                    (string("vee.ID1[") + string_number(nv) + "]/S").data());
    pklTree->Branch("vee.el", &outVee.el, "vee.el[numberOfVeeHits]/S");
    pklTree->Branch("vee.det", &outVee.det, "vee.det[numberOfVeeHits]/S");
    pklTree->Branch("vee.nEl2", &outVee.nel2,
                    (string("vee.nEl2[") + string_number(nv) + "]/S").data());
    pklTree->Branch("vee.ID2", &outVee.id2,
                    (string("vee.ID2[") + string_number(nv) + "]/S").data());
  }
}
...
ATrackTreeOutput::ATrackTreeOutput(TEvent& eventIn, TTrack** trackIn, int& nTrack, int& evtNr,
                                   int& rnNr, int& trg, int maxD, const algorithm_parameter& param)
    : AAlgorithm("Track tree output"), EventStructure(eventIn), numberOfTracks(nTrack),
      EventNumber(evtNr), RunNumber(rnNr), Trigger(trg), maxDet(maxD)
{
  tracks = trackIn;
  trackTree = NULL;
  pklTree = NULL;
...
void ATrackTreeOutput::setPrompt(int num, TTrack* tr)
{
  ...
  for (int j = 0; j < maxDet; j++) {
    for (int k = 0; k < tr->getNumberOfCalibHits(j); k++) {
      if (nPromptHit >= MAX_TRACKS * MAX_H_P_T)
        continue;
      ...
      if (tr->getCalibSrcr(j, k)->getHitShape() != NULL)
        ...
        case 6:
        case 7:
          b[nb++] = tr->getCalibSrcr(j, k);
          break;
        case 15:
        case 16:
          f[nf++] = tr->getCalibSrcr(j, k);
          break;
        }
      // 	  if(numberOfTracks==5)
      {
        if (j < 8 && tr->getCalibSrcr(j, k)->getHitShape() != NULL) {
          back = back + ((tr->getCalibSrcr(j, k)->getHitShape()->entrance(tr->getPath())) -
                         point3D(0, 0, 0));
          nb1++;
        }
        if ((j == 15 || j == 16) && tr->getCalibSrcr(j, k)->getHitShape() != NULL) {
          front = front + ((tr->getCalibSrcr(j, k)->getHitShape()->entrance(tr->getPath())) -
                           point3D(0, 0, 0));
          nf1++;
        }
      }
...
{
  if (tr->getSecondary(0) == NULL || tr->getSecondary(1) == NULL)
    return;
  ...
  for (int j = 0; j < maxDet; j++) {
    for (int k = 0; k < tr->getSecondary(0)->getNumberOfCalibHits(j); k++) {
      if (nVeeHit >= MAX_TRACKS * MAX_H_P_T)
        continue;
...
void ATrackTreeOutput::setKink(int num, TTrack* tr)
{
  ...
  for (int j = 0; j < maxDet; j++) {
    for (int k = 0; k < tr->getNumberOfCalibHits(j); k++) {
      if (nKinkHit >= MAX_TRACKS * MAX_H_P_T)
        continue;
...
void* ATrackTreeOutput::process(void* ptr)
{
  ...
  for (int i = 0; i < numberOfTracks; i++) {
    ...
    case 1: // kink
    {
      if (nKink >= MAX_TRACKS)
        continue;
      if (tracks[i]->getSecondary(0) == NULL)
        continue;
    ...
    case 2: // vee
    {
      if (nVee >= MAX_TRACKS)
        continue;
      if (tracks[i]->getSecondary(0) == NULL || tracks[i]->getSecondary(1) == NULL)
        continue;
  ...
  if (nPrompt == 2 && nVee == 1) {
    ...
    geomom = solve(tracks[0]->getPath().Direction(), tracks[1]->getPath().Direction(),
                   tracks[2]->getPath().Direction(), beam);
    pklTree->Fill();
    if (!(geomom[0] < 0 || geomom[1] < 0 || geomom[2] < 0)) {
      ...
      if(1==0)//!found)
        {
          float
      mp=Eparticles::getMassG(14),mk=Eparticles::getMassG(11),ml=Eparticles::getMassG(18);
