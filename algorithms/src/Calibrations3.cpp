...
ACutsCalibration::ACutsCalibration(TEvent &eventIn, TSetup &setup, algorithm_parameter & descr):AAlgorithm("Generate CUTS calibration"), event(eventIn), minEntriesPerHisto(descr.getParam<int>(0).getData())
{
...
ACutsCalibration::ACutsCalibration(TEvent &eventIn, TSetup &setup, vector<int> &detectors, int minEntriesPerHistoIn):AAlgorithm("Generate CUTS calibration"), event(eventIn), minEntriesPerHisto(minEntriesPerHistoIn)
{
