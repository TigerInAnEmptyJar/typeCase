...
AHitTreeOutput::AHitTreeOutput(TCalibHit ***hitIn, int **nHits, int &evtNr, int &rnNr, int &trg, int maxD, const algorithm_parameter &param):AAlgorithm("Write hit tree"),EventNumber(evtNr),RunNumber(rnNr),Trigger(trg),maxDet(maxD)
{
  numberOfHits=nHits;
  hits=hitIn;
  hitTree=NULL;
