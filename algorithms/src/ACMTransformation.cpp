...
#include <TH2.h>
ACMTransformation::ACMTransformation(TSetup &setup, momentum4D **particles, int maxPart, int &numPart,TDirectory **rootfile, int &evNr, int &runNrIn):AAlgorithm("calculate CM properties"),maxOutParticles(maxPart),numOutParticles(numPart),eventNr(evNr),runNr(runNrIn)
{
  ...
  histos[0]=new TH1F("Theta angle first particle lab|pp","Theta angle first particle lab|pp",100,0,M_PI);
  histos[1]=new TH1F("Phi angle first particle lab|pp","Phi angle first particle lab|pp",100,-M_PI,M_PI);
  histos[2]=new TH1F("cosine of Angle first particle CM|pp","cosine of Angle first particle CM|pp",100,-1,1);
  histos[3]=new TH1F("Theta angle second particle lab|pp","Theta angle second particle lab|pp",100,0,M_PI);
  histos[4]=new TH1F("Phi angle second particle lab|pp","Phi angle second particle lab|pp",100,-M_PI,M_PI);
  histos[5]=new TH1F("cosine of Angle second particle CM|pp","cosine of Angle second particle CM|pp",100,-1,1);
  histos[6]=new TH1F("cosine of Angle between particles CM|pp","cosine of Angle between particles CM|pp",100,-1,1);
  histos[7]=new TH1F("Theta angle first particle lab|dpi","Theta angle first particle lab|dpi",100,0,M_PI);
  histos[8]=new TH1F("Phi angle first particle lab|dpi","Phi angle first particle lab|dpi",100,-M_PI,M_PI);
  histos[9]=new TH1F("cosine of Angle first particle CM|dpi","cosine of Angle first particle CM|dpi",100,-1,1);
  histos[10]=new TH1F("Theta angle second particle lab|dpi","Theta angle second particle lab|dpi",100,0,M_PI);
  histos[11]=new TH1F("Phi angle second particle lab|dpi","Phi angle second particle lab|dpi",100,-M_PI,M_PI);
  histos[12]=new TH1F("cosine of Angle second particle CM|dpi","cosine of Angle second particle CM|dpi",100,-1,1);
  histos[13]=new TH1F("cosine of Angle between particles CM|dpi","cosine of Angle between particles CM|dpi",100,-1,1);
  histos[14]=new TH2F("transversal vs. parallel momentum","transversal vs. parallel momentum",100,0,CM.Momentum().length(),100,0,CM.Momentum().length());
}
...
//       vector3D part(outParticles[i]->X(),outParticles[i]->Y(),outParticles[i]->Z());
...
//     {
//       vector3D m1(/*transformedO*/outParticles[0]->Momentum()),m2(/*transformedO*/outParticles[1]->Momentum());
