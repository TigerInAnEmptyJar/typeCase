...
Q_OBJECT
 private:
  ...
  float coneLength;
 public:
  ABarrelPixel(int maxPixelsIn, int IDIn, int &numPixels, TPixel **pixelsIn, int &numHits1, int &numHits2, TCalibHit **h1, TCalibHit **h2, TDetector *front, float pixelSizeIn, int &eventNr, int &runNr, const vector<string> & fileNames);
