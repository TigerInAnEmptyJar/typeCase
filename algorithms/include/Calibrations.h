...
class APedestalCalibration: public AAlgorithm
{
 ...
 public:
  ...
  APedestalCalibration(TEvent &eventIn, TSetup &setup, vector<int> &detectors, int minEntriesPerHisto);
...
class AtdcFactorCalibration: public AAlgorithm
{
 ...
 public:
  ...
  AtdcFactorCalibration(TEvent &eventIn, TSetup &setup, vector<int> &detectors, int minEntriesPerHisto);
...
class AqdcFactorCalibration: public AAlgorithm
{
 ...
 public:
  ...
  AqdcFactorCalibration(TEvent &eventIn, TSetup &setup, vector<int> &detectors, int minEntriesPerHisto);
...
class AtdcOffsetCalibration: public AAlgorithm
{
 ...
 public:
  ...
  AtdcOffsetCalibration(TEvent &eventIn, TSetup &setup, vector<int> &detectors, int minEntriesPerHisto);
...
class AzBarrelCalibration: public AAlgorithm
{
 ...
 public:
  ...
  AzBarrelCalibration(TEvent &eventIn, TSetup &setup, vector<int> &detectors, int minEntriesPerHisto);
...
class AtdcRadialPixCalibration: public AAlgorithm
{
 ...
 public:
  ...
  AtdcRadialPixCalibration(TEvent &eventIn, TSetup &setup, vector<int> &detectors, vector<int> &Stdetectors,vector<int> pixIDs,vector<int> readSide,vector<int> pointsPerPixel, vector<string> reactionNames, int minEntriesPerHisto);
...
class AtdcRadialPolCalibration: public AAlgorithm
{
 ...
 public:
  ...
  AtdcRadialPolCalibration(TEvent &eventIn, TSetup &setup, vector<int> &detectors, vector<int> &Stdetectors, vector<int> readSide, vector<string> reactionNames, int minEntriesPerHisto);
...
class AqdcRadialPixCalibration: public AAlgorithm
{
 ...
 public:
  ...
  AqdcRadialPixCalibration(TEvent &eventIn, TSetup &setup, vector<int> &detectors, vector<int> &Stdetectors,vector<int> pixIDs,vector<int> readSide,vector<int> pointsPerPixel, vector<string> reactionNamesw, int minEntriesPerHisto);
...
class AqdcRadialPolCalibration: public AAlgorithm
{
 ...
 public:
  ...
  AqdcRadialPolCalibration(TEvent &eventIn, TSetup &setup, vector<int> &detectors, vector<int> &Stdetectors,vector<int> readSide, vector<string> reactionNames, int minEntriesPerHisto);
