...
/*   float ****parameters;//![6][numberOfElements][numberOfParameters][numRanges]//parameters[parID][elemNum][parNum][Range] */
...
/*   int **endEventRange;//![6][numberOfRanges] */
 ...
 public:
  ACalibration(TCalibHit **hitsIn, int& numberOfHitsIn, const TDetector &det,const vector<string> &filenames, int &runNr, int &evtNr, bool cA, bool cT);
