...
Q_OBJECT
 ...
 public:
 ATrackTreeInput(int &evtNrIn, int &runNrIn, int &triIn, TTrack **trackIn, int &numTrackIn, int maxTrackIn, int numDetsIn, int **numHitsIn, TCalibHit ***hitIn, int **numPixIn, TPixel ***PixIn, bool &readInValid, const algorithm_parameter &param);
