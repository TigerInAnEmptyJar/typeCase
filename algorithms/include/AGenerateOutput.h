...
/*   TVectorF *qdc,*tdc;//! */
  ...
  bool exchangeFile;
 public:
  AGenerateOutput(TEvent &evIn, const string& mcFileName, const string &outFileName, const string &localD, bool useLocalD, int maxt,bool umc,bool writeT,bool writeC,bool writeP, bool writeH, bool writeR,vector<string> reacts, int serverIn, bool addFileIn, bool exchangeFileIn, void *outmutexIn);
