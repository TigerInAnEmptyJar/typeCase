...
public:
  AHodoPixel(int IDIn, float maxChiIn, int maxPix, int& numPix, TPixel** pixIn, int maxHit,
             int& numHit1, int& numHit2, TCalibHit** hits1, TCalibHit** hits2,
             bool middlePlane = true, point3D planeP = point3D(0, 0, 17.45),
             point3D ProjectionPoint = point3D(0, 0, 0), vector3D normal = vector3D(0, 0, 1));
