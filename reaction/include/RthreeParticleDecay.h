...
public:
  ...
  void check(vector3D dirInit, vector3D dir1, vector3D dir2, vector3D dir3, double value,
             int type); // calculate properties of decay. Three particle decay
                        // needs the three
  // direction vectors and an additional value, such as Momentum (t==1),
  // Energy (t==2), KineticE (t==3), beta (t==4), with
