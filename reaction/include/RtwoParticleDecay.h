...
class RtwoParticleDecay:public TBase
{
 ...
 public:
  ...
  static float getInvariantMass(float mass1, float mass2, float theta1, float theta2, float decayingMomentum);
  static momentum4D getPrimary(float mass_p, float mass1, float mass2, vector3D dir_p, vector3D dir1, vector3D dir2);
  static momentum4D getPrimary(float mass1, float mass2, vector3D dir_p, vector3D dir1, vector3D dir2,float beta1,int ptt=0);
  static momentum4D getSecondary(float mass1, float mass2, vector3D dir_p, vector3D dir1, vector3D dir2, float value, int ptt=0);
};
