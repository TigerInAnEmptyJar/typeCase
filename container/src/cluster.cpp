...
TCluster::~TCluster() { delete[] pix; }

int TCluster::getNumberOfPixels() const { return accElem; }

int TCluster::getMaxNumberOfPixels() const { return numElem; }

point3D TCluster::getCenter() const { return cpoint; }
...
void TCluster::setID(int IDin) { id = IDin; }
int TCluster::getID() const { return id; }
int TCluster::ID() const { return id; }
...
void TCluster::setClusterRadius(float value) { radius = value; }
...
bool TCluster::isDefined() { return defined; }
