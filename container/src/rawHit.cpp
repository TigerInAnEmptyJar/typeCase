...
int TRawHit::getADC() const { return adc; }

int TRawHit::getTDC() const { return tdc; }

int TRawHit::getDetector() const { return detNum; }

int TRawHit::getElement() const { return elNum; }
...
bool TRawHit::isDefined() { return defined; }
