...
TMaterial::TMaterial(string nameIn,int max,float mass, float charge,float weight):TBase("TMaterial"),maxElements(max)
{
  name=nameIn;
...
{
  if((num<0)||(num>=numElements)) return -1;
  if(weights[num]>=0) return weights[num];
  float sum=0;
  float dist=0;
...
string TMaterial::getName()const
{
  return name;
}

void TMaterial::setName(string n)
{
  name=n;
}

int TMaterial::getNumberOfElements()const
{
  return numElements;
}

int TMaterial::getMaxNumberOfElements()const
{
  return maxElements;
}

float TMaterial::getRadiationLength()const
{
  return radiationLength;
}

float TMaterial::getDensity()const
{
  return density;
}

void TMaterial::setRadiationLength(float rad)
{
  radiationLength=rad;
}

void TMaterial::setDensity(float d)
{
  density=d;
}
...
float TMaterial::getSpeedOfLight()const
{
  return speedOfLight;
}
void TMaterial::setSpeedOfLight(float val)
{
  speedOfLight=val;
}
...
void TMaterial::setAlgorithm(AELossAlgorithm *energyLoss)
{
