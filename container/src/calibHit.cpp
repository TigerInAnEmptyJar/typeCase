...
float TCalibHit::getADC() const { return adc; }
float TCalibHit::getTDC() const { return tdc; }
...
volumeShape* TCalibHit::getHitShaper() const { return hitShape; }

int TCalibHit::getRawADC() const { return raws.getADC(); }

int TCalibHit::getRawTDC() const { return raws.getTDC(); }
int TCalibHit::getDetector() const { return raws.getDetector(); }
int TCalibHit::getElement() const { return raws.getElement(); }
...
bool TCalibHit::isDefined() { return defined; }
TRawHit& TCalibHit::getRaw() { return raws; }
bool TCalibHit::isValid() const { return valid; }
void TCalibHit::setValid(bool val) { valid = val; }
