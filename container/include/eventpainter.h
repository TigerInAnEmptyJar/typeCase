...
private:
    ...
    bool detSorted;
/*     void paintFiber(fiber &shape,float zoom,int color); */
/*     void paintSpiral(spiral &shape,float zoom,int color); */
/*     void paintWedge(wedge &shape,float zoom,int color); */
/*     void paintRing(ring &shape,float zoom,int color); */
/*     void paintHexPrism(hexPrism &shape,float zoom,int color); */
...
public:
    ...
    vector<TObject*> getDrawnObjects(double x,double y, double zoom);
public slots:
    ...
    void rePaint(TEvent *e,float zoom=100);
    void rePaint(float zoom=100);
