...
void base_parameter::setName(const string &n)
{
    name=n;    
}
...
string base_parameter::getName() const
{
    return name;
}
...
vector<string> base_parameter::getDescription() const
{
    return description;
}
...
bool base_parameter::operator<(base_parameter p)
{
...
template bool moveItemToPosVector(vector<algorithm_parameter>& vect,algorithm_parameter&item,int pos);
...
template bool moveItemToPosVector(vector<beamTime_parameter>& vect,beamTime_parameter&item,int pos);
...
template bool moveItemToPosVector<material_parameter>(vector<material_parameter>& vect,material_parameter&item,int pos);
template bool takeItemFromVector(vector<material_parameter*> &vect,material_parameter* &item);
template bool moveItemToPosVector(vector<material_parameter*>& vect,material_parameter* &item,int pos);
...
// template bool moveItemToPosVector(vector<TObject*>& vect, TObject* &item,int pos);
...
template bool moveItemToPosVector(vector<detector_parameter>& vect,detector_parameter&item,int pos);
template bool takeItemFromVector(vector<detector_parameter*> &vect,detector_parameter* &item);
template bool moveItemToPosVector(vector<detector_parameter*>& vect,detector_parameter* &item,int pos);
//#include "materialparameter.h"
// #include <TCanvas.h>
// template bool moveItemToPosVector(vector<TCanvas*>& vect,TCanvas* &item,int pos);
// template bool takeItemFromVector(vector<TCanvas*> &vect,TCanvas* &item);
//#include <qcanvaswidget.h>
// class QCanvasWidget;
// template bool moveItemToPosVector(vector<QCanvasWidget*>& vect,QCanvasWidget* &item,int pos);
// template bool takeItemFromVector(vector<QCanvasWidget*> &vect,QCanvasWidget* &item);
// #include <TH1.h>
...
template<class X>bool takeItemFromVector(vector<X> &vect,X &item)
{
  vector<X> tmp;
  bool ret=false;
...
template<class X> bool moveItemToPosVector(vector<X>& vect,X&item,int pos)
{
  X tmpI=item;
  int p1=-1;
  bool ret;
