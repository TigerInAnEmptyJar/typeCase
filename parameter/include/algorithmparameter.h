...
public:
    ...
    template<class X> void changeParam(string name, X data);
    template<class X> void changeParam(string name, const bool data[], int num);
    template<class X> void changeParam(string name, X data, int pos);
    template<class X> int getNumberOfParam()const;
    template<class X> single_parameter<X> getParam(int i) const;
    template<class X> single_parameter<X> getParam(const string &nme) const;
    template<class X> void addParam(single_parameter<X> data);
    template<class X> void popParam();
