...
template<>bool takeItemFromVector<element_parameter>(vector<element_parameter> &vect,element_parameter &item);
template<>bool moveItemToPosVector<element_parameter>(vector<element_parameter>& vect,element_parameter&item,int pos);
template<>bool takeItemFromVector<material_parameter>(vector<material_parameter> &vect,material_parameter &item);
