...
Vector volumeShape::HitParams(const sLine3D &line)
{
  return Vector(line.Foot().getDimension());
}
...
float volumeShape::getMaxDistance() const
{
    return maxDist;
}

void volumeShape::setMaxDistance(float value)
{
    maxDist=value;
}
