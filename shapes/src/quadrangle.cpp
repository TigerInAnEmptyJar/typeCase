...
quadrangle::quadrangle(point3D cent, point3D a, point3D b, point3D c, point3D d):planeShape("quadrangle")
{
  center=cent;
  A_=a;
  B_=b;
...
int quadrangle::getNumberOfPoints()const
{
  return 4;
}
point3D quadrangle::getPoint(int num)const
{
  switch(num)
    {
    case 0:return A_;break;
    case 1:return B_;break;
    case 2:return C_;break;
    case 3:return D_;break;
    }
  return point3D();
}
...
void quadrangle::Draw(const point3D &eye, const plane3D &plane, vector4D* boundingBox, TObject **ident, int lColor, int fColor, int fStyle)const
{
  point3D ps[4]={getPoint(0),getPoint(1),getPoint(2),getPoint(3)};
  DrawPoints(4, ps,eye, plane, boundingBox, ident, lColor, fColor, fStyle);
}
void quadrangle::Draw(const point3D &eye, const plane3D &plane, vector4D* boundingBox, int lColor, int fColor, int fStyle)const
{
