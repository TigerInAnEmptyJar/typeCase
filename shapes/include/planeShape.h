...
class sphericTriangle: public planeShape
{
 ...
 public:
  sphericTriangle(point3D cen, point3D a=point3D(), point3D b=point3D(), point3D c=point3D(), point3D d=point3D(), point3D e=point3D(), point3D f=point3D());
  ...
  virtual point3D getPoint(int num)const;
  void setPoint(int num, point3D p);
  void setPoints(point3D cen, point3D a, point3D b, point3D c, point3D d=point3D(), point3D e=point3D(), point3D f=point3D());
  point3D A()const;
  point3D B()const;
  point3D C()const;
  point3D D()const;
...
class rectangle:public planeShape
{
 protected:
    ...
    lLine3D right;
 public:
  rectangle(point3D A=point3D(), point3D B=point3D(), vector3D norm=vector3D(), float width=0);
  rectangle(point3D Ce, vector3D N, point3D A=point3D(), point3D B=point3D(), point3D C=point3D(), point3D D=point3D());
...
inline vector3D planeShape::getNormal()const
{
  return normal;
}

inline void planeShape::setNormal(const vector3D & v)
{
  normal=v;
}

inline float planeShape::area()const
{
  return -1;
}
