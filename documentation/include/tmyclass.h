...
class nameTypeDoc
{
 ...
 public:
  nameTypeDoc();
  nameTypeDoc(string nameIn,string typeIn,int typeIdIn=0,string specifierIn="",string docIn="",string typeDocIn="");
...
class functionNameTypeDoc:public nameTypeDoc
{
 ...
 public:
  functionNameTypeDoc();
  functionNameTypeDoc(string nameIn,string typeIn,int typeIdIn=0,string specifierIn="",string docIn="",string typeDocIn="");
  ...
  void addParameter(string nameIn,string typeIn,int typeIdIn,string specifierIn="",string docIn="",string typeDocIn="");
...
class TMyClass
{
 private:
  ...
  template<class X> void removeFromVector(vector<X>&v,int pos);
...
//  bool operator==(const TMyClass&n);
  ...
  void addSuperClass(const string &superClassName, const string& superClassDoc, int derived=0, TMyClass *super=NULL);
  ...
  void addVariable(int t, string nameIn, string typeIn,int typeIdIn,string specifier,string docIn="",string typeDocIn="");
  ...
  void addMethod(int t, string nameIn,string typeIn,int typeIdIn,string specifier,string docIn="",string typeDocIn="");
  ...
  void addSlot(int t, string nameIn,string typeIn,int typeIdIn,string specifier,string docIn="",string typeDocIn="");
  void removeSlot(int t, int i);
  void removeSlot(const string &n);
  void clearSignals();
  void addSignal(const functionNameTypeDoc &var);
  void addSignal(string nameIn,string typeIn,int typeIdIn,string specifier,string docIn="",string typeDocIn="");
  void clearConstructor();
  void addConstructor(const functionNameTypeDoc &var);
  void addConstructor(string typeIn,int typeIdIn,string specifier,string docIn="",string typeDocIn="");
