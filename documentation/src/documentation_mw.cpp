...
#else
documentation_mw::documentation_mw( QWidget* parent, Qt::WindowFlags fl )
    : QMainWindow( parent, fl )
{
    ...
    listView1->setHeaderLabels(QStringList()<<tr( "Name" ) << tr( "return type" ) << tr( "Visibility" ) << tr( "Default" ) );
...
//     textEdit1->setGeometry( QRect( 10, 280, 290, 150 ) );
    ...
    connect( listView1, SIGNAL( currentChanged(QListViewItem*) ), this, SLOT( OnPropertyClick(QListViewItem*) ) );
    ...
    connect( listView1, SIGNAL( rightButtonClicked(QListViewItem*,const QPoint&,int) ), this, SLOT( OnPropertyRightClick(QListViewItem*) ) );
    connect( listView2, SIGNAL( rightButtonClicked(QListViewItem*,const QPoint&,int) ), this, SLOT( OnSuperClassRightClick(QListViewItem*) ) );
    ...
    connect( listView2, SIGNAL( clicked(QListViewItem*) ), this, SLOT( OnSuperClassClick(QListViewItem*) ) );
...
void documentation_mw::languageChange()
{
    ...
    listView2->setHeaderLabels(QStringList()<< tr("Superclass")<<tr("Documented")<<tr("Name")<<tr("return type")<<tr("Visibility")<<tr("Default"));
#endif
