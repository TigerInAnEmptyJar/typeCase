...
#else
my_doc_classes::my_doc_classes( QWidget* parent, Qt::WindowFlags fl )
    : QWidget( parent, fl )
{
...
//     textEdit1->setGeometry( QRect( 330, 50, 168, 112 ) );
    ...
    connect( listBox1, SIGNAL( currentChanged(QListWidgetItem*) ), this, SLOT( OnClassClick(QListWidgetItem*) ) );
#endif
