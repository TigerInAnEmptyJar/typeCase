 ...
 */
#if QT_VERSION < 0x040000
doc_selectClassesDialog::doc_selectClassesDialog(QWidget* parent, const char* name, bool modal,
                                                 WFlags fl)
    ...
    : QDialog(parent, fl)
{
  ...
  toolButton1->setIcon(QIcon((string(getenv("KTOFPACK")) + "/documentation/images/undo")
                                 .data())); // QPixmap::fromMimeSource( "undo" ) ) );
  toolButton2->setIcon(QIcon((string(getenv("KTOFPACK")) + "/documentation/images/redo")
                                 .data())); // QPixmap::fromMimeSource( "redo" ) ) );
#endif
