...
void* AAlgorithm::process(void* ptr) { return ptr; }
string AAlgorithm::getName() const { return name; }
...
algorithm_parameter AAlgorithm::getDescription() { return algorithm_parameter("none", 0, 0); }
