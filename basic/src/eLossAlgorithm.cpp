...
Vector AELossAlgorithm::parameters()const
{return Vector();}
void AELossAlgorithm::setParameters(const Vector &parameter){if(parameter.getDimension()==0)return;}
AELossAlgorithm *AELossAlgorithm::getClone()const
{
  return new AELossAlgorithm(*this);
}
