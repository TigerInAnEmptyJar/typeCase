...
// vector4D::vector4D(double x, double y, double z, double w): point4D(x,y,z,w), Vector(0)
// {
// }
...
void vector4D::operator = (const Vector &v)
{
    ...
    point4D::setValues(v[0], v[1], v[2], 
		       ((v.getDimension()==3)?0:v[3]));
}
...
// {
//     return ((point4D::value4-v.W()<__prec)&&(point4D::value1-v.X()<__prec)&&(point4D::value2-v.Y()<__prec)&&(point4D::value3-v.Z()<__prec));
// }
