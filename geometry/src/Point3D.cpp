...
string point3D::toString(int pt)const
{
  ...
  if(re==_cartesic3_)return (string("(")+string_number(value1)+", "+string_number(value2)+", "+string_number(value3)+")");
  else if(re==_spheric_) 
    return (string("(")+string_number(f_theta)+", "+string_number(f_phi)+", "+string_number(f_r)+")");
  else
    return (string("(")+string_number(f_phi)+", "+string_number(f_rho)+", "+string_number(value3)+")");
}
//#endif
